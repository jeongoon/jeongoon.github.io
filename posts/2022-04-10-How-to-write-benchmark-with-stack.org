...
#+END_SRC
    ...
    the prior example is only pseudo code and I'm going to explain in [another article](https://jeongoon.github.io/posts/2022-04-10-How-to-write-benchmark-with-criterion.html).
